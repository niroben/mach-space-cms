...
<head>
    ...
    <title>Categories - Mach-space website admin tools</title>
</head>
<body>
<!-- NAVIGATION -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="dashboard.php" class=""><i class="fas fa-arrow-left"></i> Back to dashboard</a>
            </div>
        </div>
    </div>
</header>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-body bg-dark">
                            <div class="form-group">
                                <label class="formlabel" for="title">Category name:</label>
                                    <input class="form-control" type="text" name="Title" id="title" placeholder="Enter new category name here"  value="">
                            </div>
                            <button type="button" name="submit" class="btn btn-success"><i class="fas fa-plus"></i> Add</button>
                        </div>
                    </div>
